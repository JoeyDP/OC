...
\begin{document}
    ...
    \section{Introductie}
        ...
        In sectie~\ref{sec:wijzigingen} worden de wijzigingen opgelijst. Sectie~\ref{sec:motivatie} geeft de bijhorende verklaringen. Ten slotte wordt in sectie~\ref{sec:simulatie} een simulatie toegelicht.

    \newpage
    \newgeometry{left=2cm,right=2cm}
    \section{Wijzigingen}
    \label{sec:wijzigingen}
    ...
    \textcolor{red}{Deze sectie moet nog meer in detail uitgeschreven worden.}

    De volgende punten werden behouden/verbeterd ten opzichte van de huidige situatie:
    \begin{itemize}
